...
function tick()
{
    ...
    else if (time_remaining >0 && time_remaining <=10)
    {
      document.getElementById('time').style.color = "#dddd00";
...
function end()
{
    ...
    // x.
  document.getElementById('time').style.color = "#bb1111";
    ...
    for (var i=0; i<is_guessed.length; i++)
    {
        ...
        {
          document.getElementById(id).style.background = "#74C365";
        }
        else
        {
          document.getElementById(id).style.background = "#EA3C53";
        }
 ...
 */
function formatTime(time_remaining)
{
    var mm = Math.floor(time_remaining / 60);
    var ss = time_remaining % 60;
